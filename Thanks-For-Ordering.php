...
//session_start();
setcookie( "user", $username, time()-25903837 ,"/");
//session_destroy();
...
<link rel="stylesheet" href="Thanks-For-Ordering.css" media="screen">
    ...
    <meta property="og:title" content="Thanks For Ordering">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class=" u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header u-section-row-container" id="sec-1cd1" style=""><div class="u-section-rows">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-f324">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <h1 class="u-text u-text-custom-color-1 u-text-default u-title u-text-1">Thank You!</h1>
        <p class="u-large-text u-text u-text-variant u-text-2">Your order was completed successfully.<br>You will receive an email with order details.
        </p>
        <a href="Home.html" class="u-border-2 u-border-custom-color-1 u-border-hover-custom-color-2 u-btn u-btn-round u-button-style u-radius-50 u-btn-1">Back to homepage</a>
      </div>
    </section>
